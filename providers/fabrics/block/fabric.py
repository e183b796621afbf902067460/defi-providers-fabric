...
blockLimitProviderFabric.addProduct(chain='eth', limit=3000)
blockLimitProviderFabric.addProduct(chain='avax', limit=3000)
blockLimitProviderFabric.addProduct(chain='arb', limit=3000)
blockLimitProviderFabric.addProduct(chain='ftm', limit=3000)
